...
public class ParsedArtObjectQueryTest {
    ...
    @Test
    public void parserCanExtractAnArrayOfColoursOfCorrectLengthFromJSONString() {
        ParsedArtObjectQuery parsedQuery = new ParsedArtObjectQuery(testQueryString);
        ArrayList<ColourData> colours = parsedQuery.getColours();
